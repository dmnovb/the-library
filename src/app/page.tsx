    ...
    <>  
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          <span className="text-orange-600">The Library</span> allows you to read your favourite books online and offline. 
          Just upload your <span className="font-semibold underline text-orange-500">hopefully-not-pirated-pdf </span> 
          and begin reading.
        </p>
      ...
      <div>
        <div className="relative isolate">
          <div aria-hidden="true" className="pointer-events-none absolute inset-x-0.5 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <div  
            style={
              {
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">Start reading at  
            <span className="text-orange-500"> The Library.</span></h2>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-extrabold text-orange-500">Step 1</span>
              ...
              <span className="mt-2 text-zinc-2">
                ...
                <Link href="/pricing" className="text-orange-600 underline underline-offset-2">pro plan</Link>. 
              </span>
            </div>
          </li>
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-extrabold text-orange-500">Step 2</span>
              <span className="text-xl font-semibold"> Upload your PDF book file</span>
              <span className="mt-2 text-zinc-2">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-extrabold text-orange-500">Step 3</span>
